...
saudi_and_brazil %>% #the following functions are meant for ordinal
  # data, which the only piece of ordinal data I have is for "iso_code"
  # which, actually, I need to use this to split up Brazil & SA.
  # THIS IS IMPORTANT FOR WHAT I'M DOING, WHEN COMPARING 2 COUNTRIES.
  group_by(iso_code) %>%
  select(oil_production, gas_production) %>%
  plot_normality()
```
