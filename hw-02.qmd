...
# Other datasets I considered performing EDA on:
#
# dataset <- read_csv(here('daily_summary.csv'))
# dataset <- read_csv(here('population.csv'))
#
# source for all csv data: https://github.com/rfordatascience/tidytuesday/tree/master/data/2023/2023-08-22 ###
...
# This function/code doesn't work so I'm not going to hide it:
#
...
saudi_and_brazil |>
  ...
  mutate(Wealth_of_country = ifelse(Age >= 21 & Age <= 30, "Young", 
